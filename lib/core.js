...
module.exports = {
  createClass: function(chartType, methodNames, dataKey) {
    ...
    var extras = ['destroy', 'update', 'reset', 'render', 'stop', 'resize', 'clear', 'toBase64Image', 'generateLegend', 'getElementAtEvent', 'getElementsAtEvent', 'getDatasetAtEvent', 'getDatasetMeta'];
